...
#if MLP_LAYER0
DS_RESOURCE(0) StructuredBuffer<float> opacities_mlp_weights0; // feat_dim x (feat_dim + 4)
DS_RESOURCE(1) StructuredBuffer<float> opacities_mlp_bias0;
...
#else
DS_RESOURCE(0) StructuredBuffer<float> opacities_mlp_weights1; // n_feat_offsets x feat_dim
DS_RESOURCE(1) StructuredBuffer<float> opacities_mlp_bias1;

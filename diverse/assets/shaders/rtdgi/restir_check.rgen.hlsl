...
DS_RESOURCE(0) Texture2D<float> half_depth_tex;
DS_RESOURCE(1) Texture2D<uint4> temporal_reservoir_packed_tex;
DS_RESOURCE(2) RWTexture2D<uint2> reservoir_input_tex;

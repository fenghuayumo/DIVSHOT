...
DS_RESOURCE(1) Texture2D<float3> half_view_normal_tex;
DS_RESOURCE(2) Texture2D<float> depth_tex;
DS_RESOURCE(3) Texture2D<float4> candidate0_tex;
DS_RESOURCE(4) Texture2D<float4> candidate1_tex;
DS_RESOURCE(5) Texture2D<float4> candidate2_tex;
DS_RESOURCE(6) Texture2D<float4> irradiance_history_tex;
DS_RESOURCE(7) Texture2D<float4> ray_orig_history_tex;
DS_RESOURCE(8) Texture2D<float4> ray_history_tex;
DS_RESOURCE(9) Texture2D<uint> rng_history_tex;
DS_RESOURCE(10) Texture2D<uint2> reservoir_history_tex;
DS_RESOURCE(11) Texture2D<float4> reprojection_tex;
DS_RESOURCE(12) Texture2D<float4> hit_normal_history_tex;
DS_RESOURCE(13) RWTexture2D<float4> irradiance_out_tex;
DS_RESOURCE(14) RWTexture2D<float4> ray_orig_output_tex;
DS_RESOURCE(15) RWTexture2D<float4> ray_output_tex;
DS_RESOURCE(16) RWTexture2D<uint> rng_output_tex;
DS_RESOURCE(17) RWTexture2D<float4> hit_normal_output_tex;
DS_RESOURCE(18) RWTexture2D<uint2> reservoir_out_tex;

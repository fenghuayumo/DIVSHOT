...
namespace diverse
{
    namespace WindowsKeyCodes
    {
        ...
        inline diverse::InputCode::Key WindowsKeyTodiverse(uint32_t key)
        {
            static std::map<uint32_t, diverse::InputCode::Key> keyMap = {
                { KEYBOARD_A, diverse::InputCode::Key::A },
                { KEYBOARD_B, diverse::InputCode::Key::B },
                { KEYBOARD_C, diverse::InputCode::Key::C },
                { KEYBOARD_D, diverse::InputCode::Key::D },
                { KEYBOARD_E, diverse::InputCode::Key::E },
                { KEYBOARD_F, diverse::InputCode::Key::F },
                { KEYBOARD_G, diverse::InputCode::Key::G },
                { KEYBOARD_H, diverse::InputCode::Key::H },
                { KEYBOARD_I, diverse::InputCode::Key::I },
                { KEYBOARD_J, diverse::InputCode::Key::J },
                { KEYBOARD_K, diverse::InputCode::Key::K },
                { KEYBOARD_L, diverse::InputCode::Key::L },
                { KEYBOARD_M, diverse::InputCode::Key::M },
                { KEYBOARD_N, diverse::InputCode::Key::N },
                { KEYBOARD_O, diverse::InputCode::Key::O },
                { KEYBOARD_P, diverse::InputCode::Key::P },
                { KEYBOARD_Q, diverse::InputCode::Key::Q },
                { KEYBOARD_R, diverse::InputCode::Key::R },
                { KEYBOARD_S, diverse::InputCode::Key::S },
                { KEYBOARD_T, diverse::InputCode::Key::T },
                { KEYBOARD_U, diverse::InputCode::Key::U },
                { KEYBOARD_V, diverse::InputCode::Key::V },
                { KEYBOARD_W, diverse::InputCode::Key::W },
                { KEYBOARD_X, diverse::InputCode::Key::X },
                { KEYBOARD_Y, diverse::InputCode::Key::Y },
                { KEYBOARD_Z, diverse::InputCode::Key::Z },

                { KEYBOARD_0, diverse::InputCode::Key::D0 },
                { KEYBOARD_1, diverse::InputCode::Key::D1 },
                { KEYBOARD_2, diverse::InputCode::Key::D2 },
                { KEYBOARD_3, diverse::InputCode::Key::D3 },
                { KEYBOARD_4, diverse::InputCode::Key::D4 },
                { KEYBOARD_5, diverse::InputCode::Key::D5 },
                { KEYBOARD_6, diverse::InputCode::Key::D6 },
                { KEYBOARD_7, diverse::InputCode::Key::D7 },
                { KEYBOARD_8, diverse::InputCode::Key::D8 },
                { KEYBOARD_9, diverse::InputCode::Key::D9 },

                { KEYBOARD_SUBTRACT, diverse::InputCode::Key::Minus },
                { KEYBOARD_DELETE, diverse::InputCode::Key::Delete },
                { KEYBOARD_SPACE, diverse::InputCode::Key::Space },
                { KEYBOARD_LEFT, diverse::InputCode::Key::Left },
                { KEYBOARD_RIGHT, diverse::InputCode::Key::Right },
                { KEYBOARD_UP, diverse::InputCode::Key::Up },
                { KEYBOARD_DOWN, diverse::InputCode::Key::Down },
                { KEYBOARD_LSHIFT, diverse::InputCode::Key::LeftShift },
                { KEYBOARD_RSHIFT, diverse::InputCode::Key::RightShift },
                { KEYBOARD_LCONTROL, diverse::InputCode::Key::LeftControl },
                { KEYBOARD_RCONTROL, diverse::InputCode::Key::RightControl },
                { KEYBOARD_LWIN, diverse::InputCode::Key::LeftSuper },
                { KEYBOARD_RWIN, diverse::InputCode::Key::RightSuper },
                { KEYBOARD_LMENU, diverse::InputCode::Key::Menu },
                { KEYBOARD_ESCAPE, diverse::InputCode::Key::Escape },
                { KEYBOARD_ADD, diverse::InputCode::Key::Equal },
                { KEYBOARD_BACK, diverse::InputCode::Key::Backspace },
                { KEYBOARD_RETURN, diverse::InputCode::Key::Enter },
                { KEYBOARD_COMMA, diverse::InputCode::Key::Comma }
            };

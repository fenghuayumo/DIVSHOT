...
#define STATUS_TEXT_SIZE 16.0f
    ...
    public:
        ...
        static auto debug_draw(const RectLight* light, const glm::mat4& world_matrix, const LightCommon* common, const glm::vec4& colour) -> void;
        static auto debug_draw(const PointLight* light, const glm::mat4& world_matrix, const LightCommon* common, const glm::vec4& colour) -> void;
        static auto debug_draw(const SpotLight* light, const glm::mat4& world_matrix, const LightCommon* common, const glm::vec4& colour) -> void;
        static auto debug_draw(const DirectionalLight* light, const glm::mat4& world_matrix, const LightCommon* common, const glm::vec4& colour) -> void;
        static auto debug_draw(const DiskLight* light, const glm::mat4& world_matrix, const LightCommon* common, const glm::vec4& colour) -> void;
        static auto debug_draw(const CylinderLight* light, const glm::mat4& world_matrix, const LightCommon* common, const glm::vec4& colour) -> void;
        static auto debug_draw(Environment* light, const glm::mat4& world_matrix, const glm::vec4& colour) -> void;
